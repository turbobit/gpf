...
> **참고:** 바이너리는 `$GOPATH/bin`(기본값: `~/go/bin`)에 설치됩니다. 이 디렉토리가 `PATH`에 포함되어 있는지 확인하세요.

### 방법 3: GitHub Releases

[GitHub Releases](https://github.com/turbobit/gpf/releases)에서 미리 빌드된 바이너리를 다운로드할 수 있습니다.
